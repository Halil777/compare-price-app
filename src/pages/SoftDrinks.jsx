...
import { softDYnamdar } from "../data/softDYnamdar.mjs";
import { softDYuzHaryt } from "../data/softDYuzHaryt.mjs";

let drinksData = softDYnamdar.result.products;
let drinksDataYH = softDYuzHaryt.data.rows;
...
const SoftDrinks = () => {
  const [value, setValue] = useState(drinksDataYH[0]);
  const [inputValue, setInputValue] = useState("");

  const [valueSec, setValueSec] = useState(drinksData[0]);
            ...
            <Grid item sm={4}>
              <Stack direction="row" justifyContent={"center"}>
                <Autocomplete
                  ...
                  getOptionLabel={(option) => getValue1(option)}
                  sx={{ width: 300 }}
                  renderInput={(params) => (
              ...
              <Stack pt={3} direction="row" justifyContent={"center"}>
                <Card sx={{ maxWidth: 345 }}>
                  <CardActionArea sx={{ background: "#fff", width: 300 }}>
                    ...
                    />
                    <CardContent>
                      <Typography>Ady: {valueSec.p_name_tm}</Typography>
              ...
              <Stack pt={3} direction="row" justifyContent={"center"}>
                <Card sx={{ maxWidth: 345 }}>
                  <CardActionArea sx={{ background: "#fff", width: 300 }}>
                    ...
                    />
                    <CardContent>
                      <Typography>Ady: {getValue(value)}</Typography>
