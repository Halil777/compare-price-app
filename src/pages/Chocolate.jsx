...
import { dataChocolateYH } from "../data/dataChocolateYH.mjs";
import { chocoDataYnamdar } from "../data/chocoData.mjs";

let chocoItems = chocoDataYnamdar.result.products;
let dataChocoYH = dataChocolateYH.data.rows;
...
const Chocolate = () => {
  const [value, setValue] = useState(dataChocoYH[0]);
  const [inputValue, setInputValue] = useState("");

  const [valueSec, setValueSec] = useState(chocoItems[0]);
