...
import { meatDataYnamdar } from "../data/meatDataYnamdar.mjs";
import { meatDataYuzHaryt } from "../data/meatDataYuzHaryt.mjs";

let dataMeat = meatDataYnamdar.result.products;
let dataMeat1 = meatDataYuzHaryt.data.rows;
...
const MeatProducts = () => {
  const [value, setValue] = useState(dataMeat1[0]);
  const [inputValue, setInputValue] = useState("");

  const [valueSec, setValueSec] = useState(dataMeat[0]);
